...
Qualitative methods in uncertainty analysis are specifically recommended for the following purposes: 
 ...
 - When quantifying uncertainty by expert judgement, and when communicating the results of that, it may in some cases be helpful to use an [approximate probability scale with accompanying qualitative descriptors](pmcommunication.qmd#tbl-approx-probscale).
