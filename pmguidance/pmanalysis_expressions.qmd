...
<!-- SO p17 -->
Expression of uncertainty requires two components:
...
- some expression of **the probabilities** of the different answers or values. 
...
[Common concerns](pmguidance/pmanalysis_concerns.qmd){.btn .btn-primary .btn-lg role="button"}
:::
