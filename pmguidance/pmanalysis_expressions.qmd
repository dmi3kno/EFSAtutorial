...
<!-- Changed from bound to interval to avoid confusion with bounded probability -->
*Probability interval:* Uncertainty about a non-variable quantity partially quantified by specifying a bound or range with an accompanying probability or approximate probability.
