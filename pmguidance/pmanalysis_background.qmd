...
Specifically, the definition should identify the quantitative expression of uncertainty associated with the qualitative term as is done, for example, in the [EFSA approximate probability scale](pmcommunication_principles.qmd#tbl-approx-probscale)
