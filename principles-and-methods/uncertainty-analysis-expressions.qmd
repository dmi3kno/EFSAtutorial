...
---
This text is a summary from the Supporting Opinion of the Uncertainty Analysis Guidance [SO 4](https://doi.org/10.2903/j.efsa.2018.5122#efs25122-sec-0018)
...
<!-- Added sentence about interval to avoid confusion with bounded probability -->
...
A similar statement is included in EFSA’s (2009) guidance on transparency.
<!-- SO p20 -->
...
Qualitative methods in uncertainty analysis are specifically recommended for the following purposes: 
 ...
 - When quantifying uncertainty by expert judgement, and when communicating the results of that, it may in some cases be helpful to use an [approximate probability scale ](../uncertainty-communication/expressions-approximate.qmd#tbl-approx-probscale) with accompanying qualitative descriptors.
