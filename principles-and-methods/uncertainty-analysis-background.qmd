...
title: "Background"
---
This text is a summary from the Supporting Opinion of the Uncertainty Analysis Guidance [SO 1-3](https://doi.org/10.2903/j.efsa.2018.5122#efs25122-sec-0003-title)
...
A question or quantity of interest may be the subject of the assessment as a whole, i.e. that which is required by the [Terms of Reference (ToR)](https://www.efsa.europa.eu/en/efsajournal/scdocdefinitions) for the assessment, or it may be the subject of a subsidiary part of the assessment which contributes to addressing the ToR (e.g. exposure and hazard assessment are subsidiary parts of risk assessment).
...
Specifically, the definition should identify the quantitative expression of uncertainty associated with the qualitative term as is done, for example, in the [EFSA approximate probability scale](../uncertainty-communication/expressions-approximate.qmd#tbl-approx-probscale)
