...
- An approximate probability may comprise a range of probabilities chosen by the assessors from the approximate probability scale [Table 1](../uncertainty-analysis.qmd), or a different range of probabilities specified by the assessors. 
