...
- An approximate probability may comprise a range of probabilities chosen by the assessors from the [approximate probability scale](../uncertainty-communication/expressions-approximate.qmd#tbl-approx-probscale), or a different range of probabilities specified by the assessors. 
