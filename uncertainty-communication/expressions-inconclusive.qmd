...
```{r}
#| label: fig-italian
#| fig-cap: "Region of practical certatinty"
#| echo: false
knitr::include_graphics("../img/Italian4.png")
```


The threshold beyond which the probability can be rounded off to 0 or 100 % is called “practical certainty” in the Uncertainty Analysis Guidance and it should in principle be established by the decision makers (@fig-italian). 
