...
The former will generally express the overall quantified uncertainty about the assessment conclusion using probabilities, probability distributions, probability bounds, or ranges from the [approximate probability scale](uncertainty-communication-principles.qmd#tbl-approx-probscale). 
