...
This text is a summary from the Supporting Opinion of the Uncertainty Analysis Guidance [SO 15](https://doi.org/10.2903/j.efsa.2018.5122#efs25122-sec-0107) and the Guidance on Uncertainty Analysis [Ch 12](https://doi.org/10.2903/j.efsa.2018.5123#efs25123-sec-0033).
...
The former will generally express the overall quantified uncertainty about the assessment conclusion using probabilities, probability distributions, probability bounds, or ranges from the [approximate probability scale](../uncertainty-communication/expressions-approximate.qmd#tbl-approx-probscale). 
